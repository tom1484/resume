...
> **Thin overview.** This file is a short orientation pointer; the architecture is
> documented exhaustively (and accurately, with `file:line` citations) in
...
apply agent (not yet built) will submit approved applications.
...
- **Authoritative contract spec** → [`docs/CONTRACTS.md`](docs/CONTRACTS.md)
